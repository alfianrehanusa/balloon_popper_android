...
public class Tentang extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContentView = findViewById(R.id.Tentang);
        ...
        LinearLayout m4linlay = findViewById(R.id.m4linlay);
        GradientDrawable gd1 = (GradientDrawable) m4linlay.getBackground();
        gd1.setColor(ResourcesCompat.getColor(getResources(),
                R.color.google_black_light, null));

        Button m4bk = findViewById(R.id.m4bk);
        GradientDrawable gd2 = (GradientDrawable) m4bk.getBackground();
    ...
    public void Kembali(View v){
        Button b1 = findViewById(R.id.m4bk);
